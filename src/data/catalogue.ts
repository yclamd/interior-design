...
export const CATALOGUE = {
  ...
  'ottoman-600': {
    ...
    measured: false,
    source: TYPICAL,
    note: 'A seat, a surface and a toy box in one footprint. Soft on all four sides, which a coffee table is not, and light enough for a child to be allowed to move it.',
    group: 'seating',
  },
  'side-table-450': {
    name: 'Side table',
    ...
    measured: false,
    source: TYPICAL,
    note: 'Somewhere to put a cup down within reach of a seat, which is the thing rooms designed for floor space most often lack.',
    group: 'tables',
  },
  'floor-cushion': {
    name: 'Floor cushion',
  ...
  'table-dining-1200': {
    ...
    depth: 750,
    height: 740,
    clearance: { north: 750, south: 750 },
    measured: false,
    source: TYPICAL,
    note: 'Four, two down each long side. Needs 750 clear on both of those sides.',
    group: 'tables',
  },
  'table-dining-1500': {
    name: 'Dining table, 1500 × 900',
    short: 'Dining table',
    kind: 'table',
    width: 1500,
    depth: 900,
    ...
    measured: true,
    source: OWNER,
    note: 'Four comfortably at 750 each along the long sides, six at 500 each, which is tight. The 900 depth is the figure that matters: with chairs on both sides it asks for 2400 mm of room depth, and the dining room has 2600 — so it fits with 100 mm to spare at each end and nothing else can go on either of those walls.',
    group: 'tables',
  },
  'table-dining-extendable': {
    name: 'Extendable dining table, 1200/1800',
    short: 'Table',
    kind: 'table',
    width: 1200,
    depth: 800,
    ...
    clearance: { north: 750, south: 750 },
    measured: false,
    source: 'A common size for the type: 120/180 × 80 × 75 is made by several manufacturers',
    note: 'Drawn closed, at 1200. The leaf takes it to 1800, which needs 600 mm more length and nothing more in depth — so a room that fits it closed and has 600 spare at one end seats six without giving up the floor for the other 360 days.',
    group: 'tables',
  },
  'table-dining-round-1100': {
    name: 'Round dining table, 1100',
    short: 'Round table',
    kind: 'table',
    width: 1100,
    depth: 1100,
    ...
    measured: false,
    source: TYPICAL,
    note: 'Four, and no corners. A round top loses less to circulation than a rectangle of the same seating because people pass it on the diagonal, and it is the only table shape with nothing at a toddler’s eye height to run into. Give it a circular outline where it is used, so the plan and the checks both see a circle rather than the square around it.',
    group: 'tables',
  },
  'bench-dining-1600': {
    name: 'Dining bench, 1600',
    short: 'Bench',
    kind: 'chair',
    width: 1600,
    depth: 450,
    ...
    measured: false,
    source: TYPICAL,
    note: 'A bench needs no room to pull back into, so against a wall it saves the 750 mm a chair asks for. It costs everyone on it having to shuffle along, and it is the single biggest space saving available to a small dining room.',
    group: 'seating',
  },
  'table-dining-1600': {
    name: 'Dining table, 1600',
    short: 'Dining table',
    kind: 'table',
    width: 1600,
    depth: 800,
    ...
    measured: false,
    source: TYPICAL,
    note: 'Six at a push, three down each long side. Needs 750 clear on both of those sides, so it asks for 2.3 m of depth wherever it stands.',
    group: 'tables',
  },
  'desk-1100': {
    name: 'Desk, 1100',
