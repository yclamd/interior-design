...
export const CATALOGUE = {
  ...
  'fitted-run-330': {
    name: 'Fitted cabinet run, 330 deep',
    short: 'Shoe cabinet',
    kind: 'shelving',
    width: 2250,
    depth: 330,
    ...
    source: OWNER,
    madeToSize: true,
    material: 'System carcasses, built in',
    note: 'Built to the wall it stands on, so only the 330 depth is fixed. Shallow enough to be walked past in a 1.3 m entry and still take shoes.',
    group: 'storage',
  },
  'fitted-run-380': {
    name: 'Fitted cabinet run, 380 deep',
    short: 'Fitted run',
    kind: 'sideboard',
    width: 2500,
    depth: 380,
    ...
    madeToSize: true,
    material: 'System carcasses, built in',
    note: 'Built to the wall it stands on, so only the 380 depth is fixed. Shallow enough to sit in a recess without the room losing the recess.',
    group: 'storage',
  },
  'fitted-run-600': {
    name: 'Fitted cabinet run, 600 deep',
    short: 'Fitted storage',
    kind: 'shelving',
    width: 2600,
    depth: 600,
    height: 2400,
    ...
    madeToSize: true,
    material: 'System carcasses, built in',
    note: 'Built to the wall it stands on. At 600 it takes anything a wardrobe takes, and it is why a room measured at 4050 clear is 4650 wall to wall.',
    group: 'storage',
  },
  'bookshelf-490': {
    name: 'Bookshelf, 490',
